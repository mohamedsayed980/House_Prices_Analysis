...
# =============================================================================
## path = streamlit run "E:\FINAL PROJECTS\1-House_Prices_Analysis\EDA_Dashboard.py"
# ================================================================#
# =============================================================================
# A — IMPORTS
# =============================================================================
...
with st.container():
    ...
    with col_target:
        if st.session_state.df_raw is not None:
            ...
            default_idx = cols.index("price") if "price" in cols else 0
...
with tabs[2]:
    ...
    if st.session_state.df_raw is None:
        ...
        num = [c for c in st.session_state.num_cols if c in df.columns]
...
st.markdown("""
<div class="footer">
    ML Engine EDA Dashboard · Part 2 &nbsp;|&nbsp;
    Built with Streamlit · Tabs 1–8 Complete &nbsp;|&nbsp;
    Tabs 7 & 8 are new additions to the MATLAB ML Engine
</div>
""", unsafe_allow_html=True)